...
if __name__ == '__main__':
    ...
    parser.add_argument('--dir_to_save_feats', type=str, default='/mnt/data/X101-features', help='raw data')
    parser.add_argument('--dir_to_save_float16_feats', type=str, default='/mnt/data/X101-features-float16', help='new data')
