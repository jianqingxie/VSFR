...
if __name__ == '__main__':
    ...
    parser.add_argument('--concept_path', type=str, default='/home/zyq/projects/RESNets/m2_annotations/image_concepts.json')
    parser.add_argument('--enc_rpe2d', default='rpe-2.0-product-ctx-1-qkv', type=str)
    ...
    # parser.add_argument('--model_path', type=str, default='../save_model/QKV_TV2.pth')
    ...
    encoder = TransformerEncoder(3, 0, len(text_field.vocab), text_field.vocab.stoi['<pad>'], enc_rpe2d=args.enc_rpe2d, iterate_times=args.iteration_times,  use_MAA=args.use_MAA, attention_module=ScaledDotProductAttention, attention_module_kwargs={'m': args.m})
